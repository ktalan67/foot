...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ChampionnatRepository' => ['privates', 'App\\Repository\\ChampionnatRepository', 'getChampionnatRepositoryService', false],
            ...
            'App\\Repository\\ChampionnatRepository' => '?',
    ...
    /**
     * Gets the private 'App\Repository\ChampionnatRepository' shared autowired service.
     *
     * @return \App\Repository\ChampionnatRepository
     */
    protected function getChampionnatRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ChampionnatRepository.php';

        return $this->privates['App\\Repository\\ChampionnatRepository'] = new \App\Repository\ChampionnatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
